...
(sleep 8; printf 'quit\n') | ./build/client/p2p-client "${SERVER_IP}" "${PORT}" 7211 "${ROOT_DIR}/peer1" \
...
printf 'find -s 5 11831194018420276491\nrequest 5 11831194018420276491\nquit\n' | \
    ./build/client/p2p-client "${SERVER_IP}" "${PORT}" 7212 "${ROOT_DIR}/peer2" \
...
DOWNLOADED="${ROOT_DIR}/peer2/identity-source.txt"
